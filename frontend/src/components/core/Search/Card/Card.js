...
const Card = ({cardData}) => {
  ...
  return (
    <div className=' hover:scale-110 transition-all duration-300  shadow-lg outline gap-5 outline-slate-200 md:flex-row flex flex-col-reverse mt-4 px-2 py-1 rounded-sm  md:items-center justify-between min-w-full' >
     <div className=' flex justify-between  flex-col  m-0 md:pt-0 gap-3 md:gap-0'>
      ...
      <div className=' flex gap-2  md:mb-2 py-2 '>
        <button className=' bg-green-700 text-white md:px-4 md:py-2 p-2 text-sm md:text rounded-md hover:bg-green-800 transition-all duration-300'>Book</button>
